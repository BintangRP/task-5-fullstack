            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('category.edit') . $article->id }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input disabled type="img" class="form-control " name="image" required=""
                                        value="{{ 'http://127.0.0.1:8000/storage/articles/' . $article->image }}">
                                </div>
                            </div>

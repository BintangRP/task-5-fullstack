            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- article --}}
                        <form id="disabled-article" action="/articles/create" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        {{-- Categories --}}
                        <!-- General Form Elements -->
                        <form id="disabled-category" action="{{ route('category.store') }}" method="POST"
